class MyModel {
  ...
  MyModel.fromJson(Map<String, dynamic> json) {
    ...
    latlng = (json['latlng'] as List?)?.map((dynamic e) => e as int).toList();
    landlocked = json['landlocked'] as bool?;
    borders = (json['borders'] as List?)?.map((dynamic e) => e as String).toList();
    ...
    gini = (json['gini'] as Map<String,dynamic>?) != null ? Gini.fromJson(json['gini'] as Map<String,dynamic>) : null;
...
class Currencies {
  ...
  Currencies.fromJson(Map<String, dynamic> json) {
    mRU = (json['MRU'] as Map<String,dynamic>?) != null ? MRU.fromJson(json['MRU'] as Map<String,dynamic>) : null;
  }
